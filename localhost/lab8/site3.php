<h2>E-MARKETPLACES или виртуальные торговые площадки</h2>
...
<ol>
<li>создаваемые покупателями (buyer-driven),</li>
<li>продавцами (supplier-driven или seller-driven)</li>
<li>третьей стороной (third-party-driven).</li>
</ol>
...
<ol>
<li>соответствие продукции и доверие поставщику;</li>
<li>доступ к послепродажному обслуживанию;</li>
<li>цены могут быть и больше рыночной стоимости.</li>
</ol>

<p>Риски продавцов:</p>

<ol>
<li>потеря контроля над механизмами ценообразования;</li>
<li>увеличение конкуренции;</li>
<li>более сложная логистика.</li>
</ol>
