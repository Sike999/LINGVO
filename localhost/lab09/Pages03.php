...
<body>
    <?php
    if ($file = @fopen('info for site\Текст03.txt', 'r')) {
        $input = [];
    ...
    ?>
        ...
        ?>
        <div class="print">
            <h3>Не удалось открыть файл 'Текст03.txt'</h3>
        </div>
    <?php
    }
    ?>
    ...
    <div class="button_down">
        <a class="toBottom" data-to="section_3" href="javascript:void(0);">
            <svg xmlns="http://www.w3.org/2000/svg" id="arrow-circle-down" viewBox="0 0 24 24" width="25" height="35">
