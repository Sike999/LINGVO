...
<p>Фильтр:</p>
<ul>
  <li><a href="{{route('lk.index')}}?filter=active">Активные</a></li>
  <li><a href="{{route('lk.index')}}?filter=past">Прошедшие</a></li>
  <li><a href="{{route('lk.index')}}?filter=empty">Нет мест</a></li>
  <li><a href="{{route('lk.index')}}">Без фильтра</a></li>
</ul>
@endsection
