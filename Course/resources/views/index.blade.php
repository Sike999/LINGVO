...
<p>Фильтр:</p>
<ul>
 <li><a href="{{route('home')}}?filter=active">Активные</a></li>
  <li><a href="{{route('home')}}?filter=past">Прошедшие</a></li>
  <li><a href="{{route('home')}}?filter=empty">Нет мест</a></li>
  <li><a href="{{route('home')}}">Без фильтра</a></li>
</ul>
@endsection
