...
<h1>Новости науки</h1>
    ...
    <p>Фильтр:</p>
<ul>  
  <li><a href="{{route('rubrika', [$id])}}?filter=active">Активные</a></li>
  <li><a href="{{route('rubrika', [$id])}}?filter=past">Прошедшие</a></li>
  <li><a href="{{route('rubrika', [$id])}}?filter=empty">Нет мест</a></li>
  <li><a href="{{route('rubrika', [$id])}}">Без фильтра</a></li>
</ul>
@endsection
