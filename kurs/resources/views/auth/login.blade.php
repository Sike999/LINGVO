                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type ="submit" style="border-radius:8px; margin-left:140px; font-family: Open Sans Condensed; font-size:14pt; width:300px; height:40px; background-color:#7cd9c3; color:#FFFFFF; border:none;">Войти</button>
                            </div>
                        </div>
                    </form>
                </div>
